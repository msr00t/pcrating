class Rating < ActiveRecord::Base
  ...
  enum servers: {
    ...
    'Reliable servers and/or dedicated server software available': 4
  }
  ...
  enum controls: {
    ...
    'Can use a range of devices, remap all keys, and set sensitivity': 4
  }
